...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 text-center lg:text-left z-10">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-lg mx-auto lg:mx-0">
              Hệ thống đào tạo trực tuyến với hàng ngàn khóa học chất lượng từ
              các giảng viên hàng đầu. Học mọi lúc, mọi nơi.
            </p>
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <Link
                href="/courses"
                className="px-8 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-200 text-center"
              >
                Bắt đầu học ngay
              </Link>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-gray-500">
                Những khóa học được nhiều người quan tâm nhất
              </p>
            </div>
            <Link
              href="/courses"
              className="hidden md:block text-blue-600 font-bold hover:text-blue-700"
            >
              Xem tất cả &rarr;
            </Link>
          </div>
          ...
          <div className="mt-12 text-center md:hidden">
            <Link
              href="/courses"
              className="inline-block px-8 py-3 border border-blue-600 text-blue-600 font-bold rounded-xl"
            >
              Xem tất cả khóa học
            </Link>
          </div>
      ...
      // Phần hiển thị phía dưới Hero Section:
      <div className="container mx-auto px-6 py-8">
        <h3 className="text-lg font-bold mb-4">Danh mục khóa học</h3>
        <div className="flex flex-wrap gap-3">
          ...
          {categories.map((cat: any) => (
            <button
              key={cat.maDanhMuc}
              className="px-6 py-2 bg-white border border-gray-200 rounded-full hover:border-blue-600 hover:text-blue-600 transition"
            >
              {cat.tenDanhMuc}
            </button>
          ))}
